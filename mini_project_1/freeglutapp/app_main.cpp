...
void appDrawScene() {
	...
	//Horizontal Part of the A
	glLineWidth(2.5); 
	glBegin(GL_LINES);
	glColor3f(1.0, 0.0, 0.0);
	glVertex3f(-0.18, -0.12, 0.0);
	glVertex3f(-0.48, -0.12, 0);
	glEnd();
...
int main(int argc, char** argv) {
	...
	glutCreateWindow("CSE165 Mini Project 1");
